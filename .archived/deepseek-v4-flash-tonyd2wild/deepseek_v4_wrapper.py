    ...
    class _DeepseekV4Tokenizer(tokenizer.__class__):  # type: ignore
        def apply_chat_template(
            ...
            **kwargs,
            ...
            # Corrected pre-0731 wrapper: it originally mapped everything that
            # was not "none"/"max"/"xhigh" to "high", so "low" collapsed into
            # "high". Official 0731 semantics: none|off -> chat (thinking off),
