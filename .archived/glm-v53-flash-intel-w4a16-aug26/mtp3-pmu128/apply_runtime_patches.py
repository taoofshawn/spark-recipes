#!/usr/bin/env python3
"""Fail-closed installer for the native-MTP3 PMU128 image patch series.
...
after SHA-256. All outputs are derived and validated in memory (hashes +
syntax) BEFORE the first write; installation stages temp siblings and
