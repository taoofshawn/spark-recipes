# Vendored from tonyd2wild/GLM-5.3-Flash-NVFP4-2x-DGX-Spark (docker/patch_v8_fp8.py).
# fp8 MLA KV cache on SM12x: the FA2 fp8 branch forces CTA_TILE_KV=32 (a
# Hopper 228KB-smem assumption); on GB10's ~101KB opt-in max that doubles the
# tile and over-requests smem at cudaFuncSetAttribute. Cap instead of force,
# and relax the FlashInfer fp8 MLA gate to SM12x. First fp8 KV for a NoPE-MLA
# model on consumer Blackwell (GB10 / SM120).
#
