...
| modelopt.py | vllm/model_executor/layers/quantization/modelopt.py | base + our two MTP-loading fixes (`../modelopt_mtp_index.diff`) + FP8_PB_WO routed-expert alias (recipe-level, 2026-09-08 — see below) | Kai (Tech2Wild), 2026-09-05; same gaps fixed independently the same day by sfxnz (MIT) and MiaAI-Lab (AGPL), no shared code; FP8_PB_WO alias by taoofshawn 2026-09-08 (forum 382476 posts 15/17/22, matching MiaAI-Lab a1a1895c) | 6facabeaa775dd9225e7735da68dab0fc16ee5f99d04d9c88bc79de35a6b9524 |
